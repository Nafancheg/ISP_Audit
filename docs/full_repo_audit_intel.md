...
**Дата**: 09.12.2025 (обновлено 10.12.2025, 17.12.2025, 15.01.2026, 16.01.2026, 29.01.2026, 05.02.2026, 11.02.2026)
...
- В [README.md](../README.md) добавлен практический сценарий воспроизведения для P0.4: профиль `Default`, цель-браузер и темп циклов Apply/Disable, а также список артефактов для сохранения при краше.

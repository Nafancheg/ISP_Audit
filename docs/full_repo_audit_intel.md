...
Дополнение (04.02.2026): P1.11 — в Operator UI оформлен явный «шаг 4» wizard: исправление (Apply) → пост‑проверка (ретест) → краткий итог (стало лучше/частично/не помогло/не удалось проверить).

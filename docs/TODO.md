...
- [x] P2.ARCH.4: уточнить границы слоёв в архитектурной документации (допустимые зависимости для ViewModels/Orchestrator/Core) — **готово, когда** в `ARCHITECTURE_CURRENT.md` добавлен раздел «Layering contracts» и ссылки на smoke-gates.

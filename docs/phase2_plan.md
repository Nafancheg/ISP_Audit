...
1) Зафиксировать смысл стратегий в UX/логах (что именно означает TLS_FRAGMENT vs TLS_DISORDER в нашем движке).
2) Довести UI-обратную связь после apply: чёткий лог «применено/откачено» + активные флаги.

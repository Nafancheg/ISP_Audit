...
**Статус:** Архитектура актуальна. Открытые проблемы и план работ вынесены в `docs/TODO.md`.
...
2. [Bypass система](#2-bypass-система)
3. [Мониторинг и детекция](#3-мониторинг-и-детекция)
4. [UI и ViewModel](#4-ui-и-viewmodel)
5. [Файловая структура](#5-файловая-структура)
6. [Системные требования](#6-системные-требования)
7. [Changelog документа](#7-changelog-документа)

Примечание: список открытых проблем и план работ см. в `docs/TODO.md`.

---

<!-- Раздел «ЧТО ЧИНИТЬ» перенесён в docs/TODO.md -->

## 1. Критические проблемы

### ✅ Решено: Bypass применяется динамически
...
### 🔴 Проблема 1: Детекция блокировок — на авось
...
**Решение:** См. План работ (Фаза 2, задачи по детекции)

---

### 🔴 Проблема 2: Методы обхода — 20% от Zapret
...
**Решение:** Интеграция с GoodbyeDPI/Zapret или расширение WinDivertBypassManager (низкий приоритет — сначала починить то, что уже есть)
...
<!-- План работ перенесён в docs/TODO.md -->

### Фаза 1: Критический функционал (блокер)

#### ✅ Задача 1: Интеграция BypassCoordinator — готово
...
### 🎯 Целевая архитектура (✅ реализовано 02.12.2025)
...
#### ✅ Задача 2: Удаление мёртвого кода — готово
...
#### ✅ Задача 3: Включить Socket Layer мониторинг — готово
...
#### Задача 4: Retransmission tracking ⏱️ 4–6ч
...
#### Задача 5: HTTP redirect detection ⏱️ 2–3ч
...
#### Задача 6: Fail counter с time window ⏱️ 1ч

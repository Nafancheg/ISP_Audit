...
├──────────────────────────────────────────────────────────────────────────┤
│                                                                          │
│  [ 📁 Обзор... ]  C:\Games\StarCitizen\StarCitizen.exe                   │
│                                                                          │
│  [ ▶ ЗАПУСТИТЬ ДИАГНОСТИКУ ]                                             │
│                                                                          │
│  ┌─ Результаты ───────────────────────────────────────────────────────┐  │
│  │                                                                    │  │
│  │  ✓ auth.robertsspaceindustries.com:443      (54ms)                 │  │
│  │  ✓ api.robertsspaceindustries.com:443       (65ms)                 │  │
│  │  ✓ robertsspaceindustries.com:443           (58ms)                 │  │
│  │                                                                    │  │
│  │  ❌ public.universe.robertsspaceindustries.com:443                 │  │
│  │     [DNS: OK] [TCP: OK] [TLS: FAIL] -> TLS_DPI                     │  │
│  │     💡 Рекомендация: Включить TLS_DISORDER                         │  │
│  │                                                                    │  │
